...
(function (window) {
    ...
    Velveto.isBackable = function () {
        return (Velveto.history().length > 1);
    }
    ...
    Velveto.setPathData = function (dir, params, setState) {
        ...
        var _now = window.location.href;
        var _new = Velveto.getBaseURL() + '#!' + path + query;
        ...
        if (setState) {
            ...
            if (_now != _new) {
                if (_now + '/' == _new) {
                    history.replaceState(Velveto.getBaseURL(), '', _new);
                } else {
                    history.pushState(Velveto.getBaseURL(), '', _new);
                }
            }
