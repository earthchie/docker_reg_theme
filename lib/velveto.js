...
(function (window) {
	...
	Velveto.getPathData = function (path) {
		...
		if (updatePathData) {
			Velveto.setPathData(data.dir, data.params, false); // make sure url have proper format
		}
	 ...
	 * return: void
	 */
	Velveto.setPathData = function (dir, params, setState) {
        ...
        if(setState){
            ...
            history.replaceState(Velveto.getBaseURL(), '', Velveto.getBaseURL() + '#!' + path + query);
        }
	}
